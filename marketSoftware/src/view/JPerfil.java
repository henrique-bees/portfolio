...
public class JPerfil extends JFrame {
	...
	public JPerfil() {
		...
		InfoPlus usuarioP = new InfoPlus(usuario.getNome(), usuario.getCpf(), usuario.isGenero(), usuario.getSenha(),
				usuario.getDataAdmissao(), 0, 0, usuario.getIdUser());
		...
		if (imagem != null) {
			...
			Image resizedImage = originalImage.getScaledInstance(lblImagem.getWidth(), lblImagem.getHeight(),
					Image.SCALE_SMOOTH);
