...
public class JEstoque extends JFrame {
	...
	public JEstoque() {
		...
		// Início do painel de adicionar produtos.
		...
		btnAdicionarProduto.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(JEstoque.this, "Produto adicionado com sucesso!", "Sucesso",
		...
		// Início do painel de remover produtos.
